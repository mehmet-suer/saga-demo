package com.saga.payment.scheduler;

import com.saga.payment.model.entity.ProcessedEvent;
import com.saga.payment.service.ProcessedEventService;
...
public class OutboxEventScheduler {
    ...
    public void send() {
        List<ProcessedEvent> unsentEvents = processedEventService.findUnsent(PageRequest.of(0, 100));
